<template>
  <div>
    <div class="login-wrap">
      <h3>登录</h3>
      <input type="text" placeholder="peakchao" v-model="loginform.username">
      <input type="password" placeholder="123456" v-model="loginform.password">
      <el-button type="primary" @click="login(loginform)" v-loading.fullscreen.lock="fullscreenLoading">登录</el-button>
